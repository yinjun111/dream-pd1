...
setwd("C:\\Projects_External\\DREAM\\Model\\Model_C2_v1")

load("Model_GBM_C3_v1b.rdata")
...
all.model.pred.prob<-predict(gbmFit.all,newdata=data.merged,type = "prob")

Hmisc::rcorr.cens(all.model.pred.prob[!is.na(data.anno$OS),1], Surv(data.anno$OS[!is.na(data.anno$OS)], data.anno$Event[!is.na(data.anno$OS)]))


cor(all.model.pred.prob[!is.na(data.anno$OS),1],data.anno$OS[!is.na(data.anno$OS)])
